...
fun getWeatherCondition(code: Int) =
    when (code) {
        ...
        51 -> Pair(R.string.light_drizzle, R.raw.slight_rain)
        53 -> Pair(R.string.drizzle, R.raw.slight_rain)
        55 -> Pair(R.string.dense_drizzle, R.raw.slight_rain)
        56 -> Pair(R.string.light_freezing_drizzle, R.raw.slight_rain)
        57 -> Pair(R.string.dense_freezing_drizzle, R.raw.slight_rain)
